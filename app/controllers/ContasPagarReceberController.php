...
use App\Models\ContasPagarReceberModel;

class ContasPagarReceberController
{
  protected $contasModel;

  public function __construct($id = null)
  {
    $this->contasModel = new ContasPagarReceberModel($id ? $id : null);
  }

  public function find($data)
  {
    $contasModel = new ContasPagarReceberModel();
